...
#ifdef Infantry_No_1
//步兵一机械云台极限值
#define PITCH_MECHANICAL_LOW 	150.0f
#define PITCH_MECHANICAL_CENTRE 164.0f
#define PITCH_MECHANICAL_TOP	184.0f
#define YAW_MECHANICAL_CENTRE	0.26f

#elif defined(Infantry_No_2)
//步兵二机械云台极限值	
#define PITCH_MECHANICAL_LOW 	-41.0f
#define PITCH_MECHANICAL_CENTRE -22.0f
#define PITCH_MECHANICAL_TOP	-10.0f
#define YAW_MECHANICAL_CENTRE	120.0f
