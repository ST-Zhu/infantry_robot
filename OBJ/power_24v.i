...
void power_ctrl_configuration(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0010) | ((uint16_t)0x0020);
...
void power_ctrl_on(uint8_t num)
{
    ...
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1C00)), ((uint16_t)0x0004) << num);
}
...
void power_ctrl_off(uint8_t num)
{
    ...
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1C00)), ((uint16_t)0x0004) << num);
}
...
void power_ctrl_toggle(uint8_t num)
{
    ...
    GPIO_ToggleBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1C00)), ((uint16_t)0x0004) << num);
}
