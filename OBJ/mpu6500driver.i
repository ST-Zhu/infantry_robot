...
#line 20 "..\\AHRS\\mpu6500driver.c"

#line 30 "..\\AHRS\\mpu6500driver.c"
...
#line 43 "..\\AHRS\\mpu6500driver.c"

#line 55 "..\\AHRS\\mpu6500driver.c"
...
static const uint8_t write_mpu6500_reg_data_error[14][3] =
    {
        {(0X6B),
         (((~(0x1 << (0x7))) & (~(0x1 << (0x6))) & (~(0x1 << (0x5))) & (~(0x1 << (0x4))) & (~(0x1 << (0x3)))) & ((0x0 << (0x0)))),
         0x01},

        {(0X6C),
         (((~(0x1 << (0x5))) & (~(0x1 << (0x4))) & (~(0x1 << (0x3))) & (~(0x1 << (0x2))) & (~(0x1 << (0x1))) & (~(0x1 << (0x0)))) & ((0x0 << (0x6)))),
         0x02},
        ...
        {(0x1A),
         ((~(0x1 << (0x6) )) & ((0x0 << (0x3)) | (0x2 << (0x0)))),
         0x04},

        {(0x1B),
         (((~(0x1 << (0x7))) & (~(0x1 << (0x6))) & (~(0x1 << (0x5)))) & ((0x2 << (0x3)))),
         0x06},

        {(0x1C),
         (((~(0x1 << (0x7))) & (~(0x1 << (0x6))) & (~(0x1 << (0x5)))) & ((0x0 << (0x3)))),
         0x07},
        ...
        {(0X24),
         (((~(0x1 << (0x7))) & (~(0x1 << (0x5))) & (~(0x1 << (0x4)))) & ((0x1 << (0x6)) | (0xD << (0x0)))),
         0x09},

        {(0X37),
         ((~(0x1 << (0x7))) & (~(0x1 << (0x6))) & (~(0x1 << (0x5))) & (~(0x1 << (0x4))) & (~(0x1 << (0x3))) & (~(0x1 << (0x2)))) & ((0x1 << (0x1))),
         0x05},

        {(0X38),
         (((~(0x1 << (0x4))) & (~(0x1 << (0x3)))) & ((0x1 << (0x0)) )),
         0x0B},
        ...
        {(0X6A),
         (((~(0x1 << (0x7))) & (~(0x1 << (0x6))) & (~(0x1 << (0x3))) & (~(0x1 << (0x2))) & (~(0x1 << (0x1))) & (~(0x1 << (0x0)))) & ((0x1 << (0x5)) | (0x1 << (0x4)))),
         0x0A},
...
uint8_t mpu6500_init(void)
{
    ...
    mpu6500_read_single_reg((0X75));
    mpu6500_middleware_delay_us(wait_time);
    mpu6500_read_single_reg((0X75));
    mpu6500_middleware_delay_us(wait_time);

    mpu6500_write_single_reg((0X6B), (0x1 << (0x7)));
    mpu6500_middleware_delay_ms(sleepTime);
    ...
    res = mpu6500_read_single_reg((0X75));
    mpu6500_middleware_delay_us(wait_time);
    if (res != (0x70))
    {
        return 0x80;
    ...
    for (writeNum = 0; writeNum < 14; writeNum++)
    {
...
void mpu6500_read_over(uint8_t *status_buf, mpu6500_real_data_t *mpu6500_real_data)
{
    ...
    if (status_buf == 0 || mpu6500_real_data == 0)
    {
        return;
    }

    if ((*status_buf) & (0x1 << (0x6)))
    {
        mpu6500_real_data->status |= (uint8_t)(1 << 1);
    }
    if (mpu6500_real_data->status & (1 << 1))
    {
        ...
        {
            motion_time = 0;
            mpu6500_real_data->status &= ~(1 << 1);
        }
    }

    if ((*status_buf) & (0x1 << (0x0)))
    {
        int16_t temp_imu_data = 0;
        mpu6500_real_data->status |= (1 << 0);

        temp_imu_data = (int16_t)((status_buf[1]) << 8) | status_buf[2];
        mpu6500_real_data->accel[0] = temp_imu_data * 0.00059814453125f;
        temp_imu_data = (int16_t)((status_buf[3]) << 8) | status_buf[4];
        mpu6500_real_data->accel[1] = temp_imu_data * 0.00059814453125f;
        temp_imu_data = (int16_t)((status_buf[5]) << 8) | status_buf[6];
        mpu6500_real_data->accel[2] = temp_imu_data * 0.00059814453125f;

        temp_imu_data = (int16_t)((status_buf[7]) << 8) | status_buf[8];
        mpu6500_real_data->temp = temp_imu_data * 0.002f + 23.0f;

        temp_imu_data = (int16_t)((status_buf[9]) << 8) | status_buf[10];
        mpu6500_real_data->gyro[0] = temp_imu_data * 0.0005326322180158476492076f;
        temp_imu_data = (int16_t)((status_buf[11]) << 8) | status_buf[12];
        mpu6500_real_data->gyro[1] = temp_imu_data * 0.0005326322180158476492076f;
        temp_imu_data = (int16_t)((status_buf[13]) << 8) | status_buf[14];
        mpu6500_real_data->gyro[2] = temp_imu_data * 0.0005326322180158476492076f;
    }
}

void gyro_offset(float gyro_offset[3], float gyro[3], uint8_t imu_status, uint16_t *offset_time_count)
{
    if (gyro_offset == 0 || gyro == 0 || offset_time_count == 0)
    {	
        return;
    }
...
void mpu6500_read_gyro(float gyro[3])
{
    uint8_t buf[6];
    int16_t temp_imu_data = 0;
    mpu6500_read_muli_reg((0x43), buf, 6);

    temp_imu_data = (int16_t)((buf[0]) << 8) | buf[1];
    gyro[0] = temp_imu_data * 0.0005326322180158476492076f;
    temp_imu_data = (int16_t)((buf[2]) << 8) | buf[3];
    gyro[1] = temp_imu_data * 0.0005326322180158476492076f;
    temp_imu_data = (int16_t)((buf[4]) << 8) | buf[5];
    gyro[2] = temp_imu_data * 0.0005326322180158476492076f;
}
...
void mpu6500_read_accel(float accel[3])
{
    uint8_t buf[6];
    int16_t temp_imu_data = 0;
    mpu6500_read_muli_reg((0x3B), buf, 6);

    temp_imu_data = (int16_t)((buf[0]) << 8) | buf[1];
    accel[0] = temp_imu_data * 0.00059814453125f;
    temp_imu_data = (int16_t)((buf[2]) << 8) | buf[3];
    accel[1] = temp_imu_data * 0.00059814453125f;
    temp_imu_data = (int16_t)((buf[4]) << 8) | buf[5];
    accel[2] = temp_imu_data * 0.00059814453125f;
}
...
void mpu6500_read_temp(float *temperature)
{
    uint8_t buf[2];
    int16_t temp_imu_data = 0;
    mpu6500_read_muli_reg((0x41), buf, 2);

    temp_imu_data = (int16_t)((buf[0]) << 8) | buf[1];

    *temperature = temp_imu_data * 0.002f + 23.0f;
}
