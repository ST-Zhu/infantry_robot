...
void ramp_init(void)
{
	...
	ramp_start.out_L = 1450;
	ramp_start.out_R = 1450;
	
	
	ramp_start.pid_out_L = 1300;
	ramp_start.pid_out_R = 1300;
	
	enconderSys_Configure();
}
...
void ramp_calc(void)
{
	...
	if(((int16_t)ramp_start.out_L == 1300) && ((int16_t) ramp_start.out_R == 1300))
		ramp_start.back_flag = 1;
	if(((int16_t)ramp_start.out_L == 1450) && ((int16_t) ramp_start.out_R == 1450))
...
void fireMotor_stop()
{
	ramp_start.input_L = 1450;
	ramp_start.input_R = 1450;
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->CCR1 = ramp_start.out_L;
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->CCR4 = ramp_start.out_R;
}

void fireMotor_fire()
{
	ramp_start.input_L = 1300;
	ramp_start.input_R = 1300;
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->CCR1 = ramp_start.out_L;
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->CCR4 = ramp_start.out_R;
}
...
void fireMotor_keep()
{
	out[14] = Calculate_Current_Value(&pid[14], 49.0f, fire_enconderL.filter_rate);
	out[15] = Calculate_Current_Value(&pid[15], 49.0f, fire_enconderR.filter_rate);
	
	ramp_start.pid_out_L = 1300 - out[14];
	ramp_start.pid_out_R = 1300 - out[15];
	...
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->CCR1 = (int16_t)ramp_start.pid_out_L;
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->CCR4 = (int16_t)ramp_start.pid_out_R;
}
...
void enconderSys_Configure()
{
	...
	gpio.GPIO_Pin = ((uint16_t)0x1000) | ((uint16_t)0x2000);
    gpio.GPIO_Speed = GPIO_High_Speed;
	gpio.GPIO_Mode = GPIO_Mode_AF;
	gpio.GPIO_PuPd = GPIO_PuPd_UP;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)),&gpio);
	
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)),((uint8_t)0x0C),((uint8_t)0x02));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)),((uint8_t)0x0D),((uint8_t)0x02));
	TIM_EncoderInterfaceConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((uint16_t)0x0003), ((uint16_t)0x0002), ((uint16_t)0x0002));
	...
	gpio.GPIO_Pin = ((uint16_t)0x0400) | ((uint16_t)0x0800);
    gpio.GPIO_Speed = GPIO_High_Speed;
	gpio.GPIO_Mode = GPIO_Mode_AF;
	gpio.GPIO_PuPd = GPIO_PuPd_UP;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1C00)),&gpio);
	
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1C00)),((uint8_t)0x0A),((uint8_t)0x02));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1C00)),((uint8_t)0x0B),((uint8_t)0x02));
	TIM_EncoderInterfaceConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((uint16_t)0x0003), ((uint16_t)0x0002), ((uint16_t)0x0002));
...
void getEnconderData_fire(Fire_Enconder *Enc, char TIM_temp)
{
	...
	if(TIM_temp == 'L')
		Enc->value = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CNT;
	else if(TIM_temp == 'R')
		Enc->value = -((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00))->CNT;
	...
	Enc->filter_rate = (int32_t)(temp_sum/5);
}
