...
#line 1135 "..\\FWLIB\\inc\\stm32f4xx_fmc.h"
...
#line 37 "..\\FWLIB\\src\\stm32f4xx_fmc.c"
#line 38 "..\\FWLIB\\src\\stm32f4xx_fmc.c"
...
void FMC_NORSRAMDeInit(uint32_t FMC_Bank)
{
  ...
  if(FMC_Bank == ((uint32_t)0x00000000))
  {
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_Bank] = 0x000030DB;    
  }
   
  else
  {   
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_Bank] = 0x000030D2; 
  }
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_Bank + 1] = 0x0FFFFFFF;
  ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[FMC_Bank] = 0x0FFFFFFF;  
}
...
void FMC_NORSRAMInit(FMC_NORSRAMInitTypeDef* FMC_NORSRAMInitStruct)
{
  ...
  tmpbcr = ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_NORSRAMInitStruct->FMC_Bank];
 
  
 
  tmpbcr &= ((uint32_t)~(((uint32_t)0x00000001)   | ((uint32_t)0x00000002)    | ((uint32_t)0x0000000C)     |                          ((uint32_t)0x00000030)     | ((uint32_t)0x00000040)   | ((uint32_t)0x00000100)  |                          ((uint32_t)0x00000200)  | ((uint32_t)0x00000400)  | ((uint32_t)0x00000800)  |                          ((uint32_t)0x00001000)     | ((uint32_t)0x00002000)   | ((uint32_t)0x00004000)   |                          ((uint32_t)0x00008000)| ((uint32_t)0x00080000) | ((uint32_t)0x00100000)));
  ...
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_NORSRAMInitStruct->FMC_Bank] = tmpbcr;

  if(FMC_NORSRAMInitStruct->FMC_MemoryType == ((uint32_t)0x00000008))
  {
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_NORSRAMInitStruct->FMC_Bank] |= (uint32_t)((uint32_t)0x00000040);
  }

   
  if((FMC_NORSRAMInitStruct->FMC_ContinousClock == ((uint32_t)0x00100000)) && (FMC_NORSRAMInitStruct->FMC_Bank != ((uint32_t)0x00000000)))
  {
    tmpr = (uint32_t)((((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[((uint32_t)0x00000000)+1]) & ~(((uint32_t)0x0F) << 20));    
    
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[((uint32_t)0x00000000)]  |= FMC_NORSRAMInitStruct->FMC_ContinousClock;
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[((uint32_t)0x00000000)]  |= ((uint32_t)0x00000100);
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[((uint32_t)0x00000000)+1] = (uint32_t)(tmpr | (((FMC_NORSRAMInitStruct->FMC_ReadWriteTimingStruct->FMC_CLKDivision)-1) << 20));
  }
  
   
  ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_NORSRAMInitStruct->FMC_Bank+1] =   
  ...
  if(FMC_NORSRAMInitStruct->FMC_ExtendedMode == ((uint32_t)0x00004000))
  {
    ((void)0);
    ((void)0);
    ((void)0);
    ...
    tmpbwr = ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[FMC_NORSRAMInitStruct->FMC_Bank];
    ...
    ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[FMC_NORSRAMInitStruct->FMC_Bank] = tmpbwr;
  }
  else
  {
    ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[FMC_NORSRAMInitStruct->FMC_Bank] = 0x0FFFFFFF;
  }
...
{  
  ...
  FMC_NORSRAMInitStruct->FMC_Bank = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_DataAddressMux = ((uint32_t)0x00000002);
  FMC_NORSRAMInitStruct->FMC_MemoryType = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_MemoryDataWidth = ((uint32_t)0x00000010);
  FMC_NORSRAMInitStruct->FMC_BurstAccessMode = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_AsynchronousWait = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_WaitSignalPolarity = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_WrapMode = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_WaitSignalActive = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_WriteOperation = ((uint32_t)0x00001000);
  FMC_NORSRAMInitStruct->FMC_WaitSignal = ((uint32_t)0x00002000);
  FMC_NORSRAMInitStruct->FMC_ExtendedMode = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_WriteBurst = ((uint32_t)0x00000000);
  FMC_NORSRAMInitStruct->FMC_ContinousClock = ((uint32_t)0x00000000);
...
void FMC_NORSRAMCmd(uint32_t FMC_Bank, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_Bank] |= ((uint32_t)0x00000001);
  }
  else
  {
     
    ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FMC_Bank] &= ((uint32_t)0x000FFFFE);
  }
}
...
void FMC_NANDDeInit(uint32_t FMC_Bank)
{
  ...
  if(FMC_Bank == ((uint32_t)0x00000010))
  {
     
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2 = 0x00000018;
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->SR2 = 0x00000040;
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PMEM2 = 0xFCFCFCFC;
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PATT2 = 0xFCFCFCFC;  
  }
     
  else
  {
     
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3 = 0x00000018;
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->SR3 = 0x00000040;
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PMEM3 = 0xFCFCFCFC;
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PATT3 = 0xFCFCFCFC; 
  }  
}
...
void FMC_NANDInit(FMC_NANDInitTypeDef* FMC_NANDInitStruct)
{
  ...
  if(FMC_NANDInitStruct->FMC_Bank == ((uint32_t)0x00000010))
  {
     
    tmppcr = ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2;
  }
  else
  {
     
    tmppcr = ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3;
  }
  ...
  if(FMC_NANDInitStruct->FMC_Bank == ((uint32_t)0x00000010))
  {
    ...
    tmppmem = ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PMEM2;
  }
  else
  {
     
    tmppmem = ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PMEM3;
  } 
  ...
  if(FMC_NANDInitStruct->FMC_Bank == ((uint32_t)0x00000010))
  {
    ...
    tmppatt = ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PATT2;
  }
  else
  {
     
    tmppatt = ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PATT3;
  } 
  ...
  if(FMC_NANDInitStruct->FMC_Bank == ((uint32_t)0x00000010))
  {
    ...
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2 = tmppcr;
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PMEM2 = tmppmem;
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PATT2 = tmppatt;
  }
  else
  {
     
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3 = tmppcr;
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PMEM3 = tmppmem;
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PATT3 = tmppatt;
  }
}
...
{ 
  ...
  FMC_NANDInitStruct->FMC_Bank = ((uint32_t)0x00000010);
  FMC_NANDInitStruct->FMC_Waitfeature = ((uint32_t)0x00000000);
  FMC_NANDInitStruct->FMC_MemoryDataWidth = ((uint32_t)0x00000010);
  FMC_NANDInitStruct->FMC_ECC = ((uint32_t)0x00000000);
  FMC_NANDInitStruct->FMC_ECCPageSize = ((uint32_t)0x00000000);
...
void FMC_NANDCmd(uint32_t FMC_Bank, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    if(FMC_Bank == ((uint32_t)0x00000010))
    {
      ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2 |= ((uint32_t)0x00000004);
    }
    else
    {
      ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3 |= ((uint32_t)0x00000004);
    }
  }
  else
  {
    ...
    if(FMC_Bank == ((uint32_t)0x00000010))
    {
      ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2 &= ((uint32_t)0x000FFFFB);
    }
    else
    {
      ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3 &= ((uint32_t)0x000FFFFB);
    }
  }
}
...
void FMC_NANDECCCmd(uint32_t FMC_Bank, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    if(FMC_Bank == ((uint32_t)0x00000010))
    {
      ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2 |= ((uint32_t)0x00000040);
    }
    else
    {
      ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3 |= ((uint32_t)0x00000040);
    }
  }
  else
  {
    ...
    if(FMC_Bank == ((uint32_t)0x00000010))
    {
      ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2 &= ((uint32_t)0x000FFFBF);
    }
    else
    {
      ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3 &= ((uint32_t)0x000FFFBF);
    }
  }
}
...
uint32_t FMC_GetECC(uint32_t FMC_Bank)
{
  ...
  if(FMC_Bank == ((uint32_t)0x00000010))
  {
    ...
    eccval = ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->ECCR2;
  }
  else
  {
     
    eccval = ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->ECCR3;
  }
...
void FMC_PCCARDDeInit(void)
{
  ...
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PCR4 = 0x00000018; 
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->SR4 = 0x00000000;	
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PMEM4 = 0xFCFCFCFC;
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PATT4 = 0xFCFCFCFC;
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PIO4 = 0xFCFCFCFC;
}
...
void FMC_PCCARDInit(FMC_PCCARDInitTypeDef* FMC_PCCARDInitStruct)
{
  ...
  tmppcr = ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PCR4;
  
   
  tmppcr &= ((uint32_t)~(((uint32_t)0x0001E000)  | ((uint32_t)0x00001E00) | ((uint32_t)0x00000002) |                          ((uint32_t)0x00000030)));
  ...
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PCR4 = tmppcr;

   
  tmpmem = ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PMEM4;
  
   
  tmpmem &= ((uint32_t)~(((uint32_t)0x000000FF)  | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000) |                          ((uint32_t)0xFF000000)));
  ...
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PMEM4 = tmpmem; 

   
  tmppatt = ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PATT4;
  ...
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PATT4 = tmppatt;

   
  tmppio = ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PIO4;

   
  tmppio &= ((uint32_t)~(((uint32_t)0x000000FF)  | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000) |                          ((uint32_t)0xFF000000)));
  ...
  ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PIO4 = tmppio;
}
...
void FMC_PCCARDStructInit(FMC_PCCARDInitTypeDef* FMC_PCCARDInitStruct)
{
  ...
  FMC_PCCARDInitStruct->FMC_Waitfeature = ((uint32_t)0x00000000);
...
void FMC_PCCARDCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PCR4 |= ((uint32_t)0x00000004);
  }
  else
  {
     
    ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PCR4 &= ((uint32_t)0x000FFFFB);
  }
}
...
void FMC_SDRAMDeInit(uint32_t FMC_Bank)
{
  ...
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[FMC_Bank] = 0x000002D0;
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDTR[FMC_Bank] = 0x0FFFFFFF;    
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCMR = 0x00000000;
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDRTR = 0x00000000;
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDSR = 0x00000000; 
}  
...
{ 
  ...
  tmpr1 = ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[FMC_SDRAMInitStruct->FMC_Bank];

   
  tmpr1 &= ((uint32_t)~(((uint32_t)0x00000003) | ((uint32_t)0x0000000C) | ((uint32_t)0x00000030) |                         ((uint32_t)0x00000040) | ((uint32_t)0x00000180) | ((uint32_t)0x00000200) |                         ((uint32_t)0x00000C00) | ((uint32_t)0x00001000) | ((uint32_t)0x00006000)));
  ...
  if(FMC_SDRAMInitStruct->FMC_Bank == ((uint32_t)0x00000000) )
  {
    ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[FMC_SDRAMInitStruct->FMC_Bank] = tmpr1;
  }
  else    
  {
     
    tmpr3 = ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[((uint32_t)0x00000000)];

     
    tmpr3 &= ((uint32_t)~(((uint32_t)0x00000003)  | ((uint32_t)0x0000000C) | ((uint32_t)0x00000030) |                           ((uint32_t)0x00000040)  | ((uint32_t)0x00000180) | ((uint32_t)0x00000200) |                           ((uint32_t)0x00000C00) | ((uint32_t)0x00001000) | ((uint32_t)0x00006000)));
    ...
    ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[((uint32_t)0x00000000)] = tmpr3;
    ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[FMC_SDRAMInitStruct->FMC_Bank] = tmpr1;
  }
  ...
  if(FMC_SDRAMInitStruct->FMC_Bank == ((uint32_t)0x00000000) )
  {
    ...
    tmpr2 = ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDTR[FMC_SDRAMInitStruct->FMC_Bank];

     
    tmpr2 &= ((uint32_t)~(((uint32_t)0x0000000F)  | ((uint32_t)0x000000F0) | ((uint32_t)0x00000F00) |                           ((uint32_t)0x0000F000)  | ((uint32_t)0x000F0000) | ((uint32_t)0x00F00000) |                           ((uint32_t)0x0F000000)));
    ...
    tmpr2 |=   (uint32_t)((FMC_SDRAMInitStruct->FMC_SDRAMTimingStruct->FMC_LoadToActiveDelay)-1) |
            ...
            ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDTR[FMC_SDRAMInitStruct->FMC_Bank] = tmpr2;
  }
  else    
  {
    ...
    tmpr4 = ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDTR[((uint32_t)0x00000000)];

     
    tmpr4 &= ((uint32_t)~(((uint32_t)0x0000000F)  | ((uint32_t)0x000000F0) | ((uint32_t)0x00000F00) |                           ((uint32_t)0x0000F000)  | ((uint32_t)0x000F0000) | ((uint32_t)0x00F00000) |                           ((uint32_t)0x0F000000)));
    ...
    tmpr4 |=   (uint32_t)(((FMC_SDRAMInitStruct->FMC_SDRAMTimingStruct->FMC_RowCycleDelay)-1) << 12) |
            ...
            ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDTR[((uint32_t)0x00000000)] = tmpr4;
            ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDTR[FMC_SDRAMInitStruct->FMC_Bank] = tmpr2;
  }
...
{  
  ...
  FMC_SDRAMInitStruct->FMC_Bank = ((uint32_t)0x00000000);
  FMC_SDRAMInitStruct->FMC_ColumnBitsNumber = ((uint32_t)0x00000000);
  FMC_SDRAMInitStruct->FMC_RowBitsNumber = ((uint32_t)0x00000000); 
  FMC_SDRAMInitStruct->FMC_SDMemoryDataWidth = ((uint32_t)0x00000010);
  FMC_SDRAMInitStruct->FMC_InternalBankNumber = ((uint32_t)0x00000040); 
  FMC_SDRAMInitStruct->FMC_CASLatency = ((uint32_t)0x00000080);  
  FMC_SDRAMInitStruct->FMC_WriteProtection = ((uint32_t)0x00000200);
  FMC_SDRAMInitStruct->FMC_SDClockPeriod = ((uint32_t)0x00000000);
  FMC_SDRAMInitStruct->FMC_ReadBurst = ((uint32_t)0x00000000);
  FMC_SDRAMInitStruct->FMC_ReadPipeDelay = ((uint32_t)0x00000000); 
...
void FMC_SDRAMCmdConfig(FMC_SDRAMCommandTypeDef* FMC_SDRAMCommandStruct)
{
  ...
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCMR = tmpr;
...
uint32_t FMC_GetModeStatus(uint32_t SDRAM_Bank)
{
  ...
  if(SDRAM_Bank == ((uint32_t)0x00000000))
  {
    tmpreg = (uint32_t)(((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDSR & ((uint32_t)0x00000006)); 
  }
  else
  {
    tmpreg = ((uint32_t)(((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDSR & ((uint32_t)0x00000018)) >> 2);
  }
...
void FMC_SetRefreshCount(uint32_t FMC_Count)
{
  ...
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDRTR |= (FMC_Count<<1);
...
void FMC_SetAutoRefresh_Number(uint32_t FMC_Number)
{
  ...
  ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCMR |= (FMC_Number << 5);   
}
...
void FMC_SDRAMWriteProtectionConfig(uint32_t SDRAM_Bank, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[SDRAM_Bank] |= ((uint32_t)0x00000200);    
  }
  else
  {
    ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDCR[SDRAM_Bank] &= ((uint32_t)0x00007DFF);
  } 
...
void FMC_ITConfig(uint32_t FMC_Bank, uint32_t FMC_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    if(FMC_Bank == ((uint32_t)0x00000010))
    {
      ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->SR2 |= FMC_IT;
    }
     
    else if (FMC_Bank == ((uint32_t)0x00000100))
    {
      ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->SR3 |= FMC_IT;
    }
     
    else if (FMC_Bank == ((uint32_t)0x00001000))
    {
      ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->SR4 |= FMC_IT;    
    }
     
    else
    {
       
      ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDRTR |= FMC_IT; 
    }
  }
  else
  {
    ...
    if(FMC_Bank == ((uint32_t)0x00000010))
    {
      ...
      ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->SR2 &= (uint32_t)~FMC_IT;
    }
     
    else if (FMC_Bank == ((uint32_t)0x00000100))
    {
      ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->SR3 &= (uint32_t)~FMC_IT;
    }
     
    else if(FMC_Bank == ((uint32_t)0x00001000))
    {
      ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->SR4 &= (uint32_t)~FMC_IT;    
    }
     
    else
    {
       
      ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDRTR &= (uint32_t)~FMC_IT; 
    }
  }
}
...
FlagStatus FMC_GetFlagStatus(uint32_t FMC_Bank, uint32_t FMC_FLAG)
{
  ...
  if(FMC_Bank == ((uint32_t)0x00000010))
  {
    tmpsr = ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->SR2;
  }  
  else if(FMC_Bank == ((uint32_t)0x00000100))
  {
    tmpsr = ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->SR3;
  }
  else if(FMC_Bank == ((uint32_t)0x00001000))
  {
    tmpsr = ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->SR4;
  }
  else 
  {
    tmpsr = ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDSR;
  }
...
void FMC_ClearFlag(uint32_t FMC_Bank, uint32_t FMC_FLAG)
{
  ...
  if(FMC_Bank == ((uint32_t)0x00000010))
  {
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->SR2 &= (~FMC_FLAG); 
  }  
  else if(FMC_Bank == ((uint32_t)0x00000100))
  {
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->SR3 &= (~FMC_FLAG);
  }
  else if(FMC_Bank == ((uint32_t)0x00001000))
  {
    ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->SR4 &= (~FMC_FLAG);
  }
   
  else
  {
    ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDRTR &= (~FMC_FLAG);
  }
...
ITStatus FMC_GetITStatus(uint32_t FMC_Bank, uint32_t FMC_IT)
{
  ...
  {
    tmpsr = ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDRTR;
    tmpsr2 = ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDSR;
  } 
  ...
  if((FMC_Bank == ((uint32_t)0x00000000)) || (FMC_Bank == ((uint32_t)0x00000001)))
  {
    itstatus = tmpsr2 & ((uint32_t)0x00000001);  
  }           
  else
  {
...
void FMC_ClearITPendingBit(uint32_t FMC_Bank, uint32_t FMC_IT)
{
  ...
  if(FMC_Bank == ((uint32_t)0x00000010))
  {
    ((FMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->SR2 &= ~(FMC_IT >> 3); 
  }  
  else if(FMC_Bank == ((uint32_t)0x00000100))
  {
    ((FMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->SR3 &= ~(FMC_IT >> 3);
  }
  else if(FMC_Bank == ((uint32_t)0x00001000))
  {
    ((FMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->SR4 &= ~(FMC_IT >> 3);
  }
   
  else
  {
    ((FMC_Bank5_6_TypeDef *) (((uint32_t)0xA0000000) + 0x0140))->SDRTR |= ((uint32_t)0x00000001);
  }
}
