...
#line 236 "..\\FWLIB\\inc\\stm32f4xx_pwr.h"
...
#line 39 "..\\FWLIB\\src\\stm32f4xx_pwr.c"
#line 40 "..\\FWLIB\\src\\stm32f4xx_pwr.c"
...
#line 101 "..\\FWLIB\\src\\stm32f4xx_pwr.c"
...
#line 122 "..\\FWLIB\\src\\stm32f4xx_pwr.c"
...
#line 333 "..\\FWLIB\\src\\stm32f4xx_pwr.c"
...
{ 
  ...
  if (NewState != DISABLE)
  {
    *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x0B * 4)) = (uint32_t)ENABLE;
  }
  else
  {
    *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x0B * 4)) = (uint32_t)DISABLE;
  }
}
...
void PWR_LowRegulatorUnderDriveCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x0A * 4)) = (uint32_t)ENABLE;
  }
  else
  {
    *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x0A * 4)) = (uint32_t)DISABLE;
  }
}


#line 641 "..\\FWLIB\\src\\stm32f4xx_pwr.c"
...
void PWR_ClearFlag(uint32_t PWR_FLAG)
{
  ...
  if (PWR_FLAG != ((uint32_t)0x000C0000))
  {
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR |=  PWR_FLAG << 2;
  }
  else
  {
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CSR |= ((uint32_t)0x000C0000);
  }
