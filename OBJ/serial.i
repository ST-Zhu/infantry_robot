...
void miniPC_uart6_init(void)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00000040),ENABLE); 
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000020), ENABLE);;
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00400000), ENABLE); 
 
	
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint8_t)0x09), ((uint8_t)0x08)); 
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint8_t)0x0E), ((uint8_t)0x08)); 
	...
	USART_DeInit(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)));
	...
	USART_Init(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)), &USART_InitStructure); 
	
	USART_Cmd(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)), ENABLE);  
	
	USART_DMACmd(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)),((uint16_t)0x0040),ENABLE);  
	...
	DMA_DeInit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028))); 	
	while (DMA_GetCmdStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028))) != DISABLE);
	DMA_InitStructure.DMA_Channel = ((uint32_t)0x0A000000);  
	DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)&(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))->DR);
	DMA_InitStructure.DMA_Memory0BaseAddr = (u32)SEE_RXBuff;
	...
	DMA_Init(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), &DMA_InitStructure);
	DMA_ITConfig(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),((uint32_t)0x00000010),ENABLE);
	DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),ENABLE);
...
{
	if(DMA_GetFlagStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),((uint32_t)0x10000800))!=RESET)
	{
		DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), DISABLE); 
		DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),((uint32_t)0x10000800) | ((uint32_t)0x10000040) | ((uint32_t)0x10000100) | ((uint32_t)0x10000200) | ((uint32_t)0x10000400));
		DMA_ClearITPendingBit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), ((uint32_t)0x10008800));		
...
void miniPC_uart6_tx(u8 *USART_RX_BUF ,int len)
{
			...
			for(t=0;t<len;t++)
			{
				USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)), USART_RX_BUF[t]);         
				while(USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)),((uint16_t)0x0040))!=SET);
			}
}
int64_t usart_see = 0;
int16_t yaw_yaw = 0;
...
void getVisionData(u8* data,VisionData* enemy_position)
{
	...
	if(data[0] == 0xA5 && Verify_CRC16_Check_Sum(data,18)) 
	{
		...
		out[12] = Calculate_Current_Value_For_Err(&pid[12], FOA.yaw_offset);
		out[13] = Calculate_Current_Value_For_Err(&pid[13], FOA.pitch_offset);
