...
uint8_t CAN1_mode_init(uint8_t tsjw, uint8_t tbs2, uint8_t tbs1, uint16_t brp, uint8_t mode)
{
    ...
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint8_t)0x00), ((uint8_t)0x09));
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint8_t)0x01), ((uint8_t)0x09));
...
void CAN1_STOP()
{
    ...
    CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000001),DISABLE);
}
void CAN1_START()
{
	  CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000002),ENABLE);
    CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000001),ENABLE);
}
...
{   
	 CanRxMsg rx_message;	
    if (CAN_GetITStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000002))!= RESET)
	{
        CAN_ClearITPendingBit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint32_t)0x00000004));
		CAN_ClearFlag(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint32_t)0x32000008)); 
		CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint8_t)0x00), &rx_message);
