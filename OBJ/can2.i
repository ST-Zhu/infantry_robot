...
uint8_t CAN2_mode_init(uint8_t tsjw, uint8_t tbs2, uint8_t tbs1, uint16_t brp, uint8_t mode)
{
    ...
    CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)), ((uint32_t)0x00000002), ENABLE);
...
void CAN2_STOP()
{
	  CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint32_t)0x00000002),DISABLE);
    CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint32_t)0x00000001),DISABLE);
}
void CAN2_START()
{
	  CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint32_t)0x00000002),ENABLE);
    CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint32_t)0x00000001),ENABLE);
}
...
{
    CanRxMsg rx_message;
    if (CAN_GetITStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint32_t)0x00000002))!= RESET) 
    {
        CAN_ClearITPendingBit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)), ((uint32_t)0x00000002));
        CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)), ((uint8_t)0x00), &rx_message);  
