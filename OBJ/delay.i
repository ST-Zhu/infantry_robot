...
void delay_init(u8 SYSCLK)
{
	...
	fac_us=SYSCLK/8;						
#line 131 "..\\SYSTEM\\delay\\delay.c"
	fac_ms=(u16)fac_us*1000;				

}								    

#line 176 "..\\SYSTEM\\delay\\delay.c"
...
{		
	u32 temp;	    	 
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD=nus*fac_us; 				
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL=0x00;        				
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL|=(1UL ) ; 
	do
	{
		temp=((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL;
...
{	 		  	  
	u32 temp;		   
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD=(u32)nms*fac_ms;			
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL =0x00;           			
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL|=(1UL ) ;          
	do
	{
