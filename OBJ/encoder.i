...
void CanReceiveMsgProcess(CanRxMsg *message)
{
	...
	{
		case 0x201:    	getEncoderData(&CM1Encoder, message);   	break;
            
		case 0x202:    	getEncoderData(&CM2Encoder, message); 	  break;

		case 0x203:  	  getEncoderData(&CM3Encoder, message);   	break;

		case 0x204:	    getEncoderData(&CM4Encoder, message); 	  break;

		case 0x205:	    getEncoderData(&GMYawEncoder, message);	  break;

		case 0x206:	  getEncoderData(&GMPitchEncoder, message); break;
		
		case 0x207:  getEncoderData(&CMFeedEncoder, message);  break;
	}
}
...
void getEncoderData(volatile Encoder *v, CanRxMsg * msg)
{
	...
	v->filter_rate = (int32_t)(temp_sum/6);
