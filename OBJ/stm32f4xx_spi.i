...
#line 540 "..\\FWLIB\\inc\\stm32f4xx_spi.h"
...
#line 160 "..\\FWLIB\\src\\stm32f4xx_spi.c"
#line 161 "..\\FWLIB\\src\\stm32f4xx_spi.c"
...
#line 409 "..\\FWLIB\\src\\stm32f4xx_spi.c"
    ...
    if((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR & ((uint32_t)0x00400000)) == ((uint32_t)0x00400000))
    {
      ...
      i2sclk = (uint32_t)(((((uint32_t)12000000) / pllm) * plln) / pllr);
    }
    else
    {  
...
#line 485 "..\\FWLIB\\src\\stm32f4xx_spi.c"
