...
#line 2 "..\\BSP\\JudgeSystem.c"

fifo_s_t* JudgeSystemUart3_RXFIFO;		
u8 RX3Buff[160];		
...
void JudgeSystem_uart7_init(void)
{
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	RCC_APB1PeriphClockCmd(((uint32_t)0x40000000),ENABLE);
	
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00200000),ENABLE);  
 
	
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), ((uint8_t)0x07), ((uint8_t)0x08)); 
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), ((uint8_t)0x08), ((uint8_t)0x08)); 
	
	
  GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0080) | ((uint16_t)0x0100); 
	...
	USART_DeInit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800)));
  ...
  USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800)), &USART_InitStructure); 
	
  USART_Cmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800)), ENABLE);  
	USART_ITConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800)), ((uint16_t)0x0424), ENABLE);
	USART_DMACmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800)),((uint16_t)0x0040),ENABLE);	
  ...
  NVIC_InitStructure.NVIC_IRQChannel = UART7_IRQn;
	...
	DMA_DeInit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))); 
  DMA_InitStructure.DMA_Channel = ((uint32_t)0x0A000000);  
  DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)&(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800))->DR);
  DMA_InitStructure.DMA_Memory0BaseAddr = (u32)RX3Buff;
  ...
  DMA_InitStructure.DMA_MemoryBurst = ((uint32_t)0x00000100);
  DMA_InitStructure.DMA_PeripheralBurst = ((uint32_t)0x00000000);
	
  DMA_Init(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058)), &DMA_InitStructure);


	DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058)),ENABLE);
	
	JudgeSystemUart3_RXFIFO = fifo_s_create(140);		
...
unpack_data_t p_obj;	
	...
	if(USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800)), ((uint16_t)0x0424)) != RESET)  
	{
		num = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800))->SR;
		num = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7800))->DR;	
				
		 	
		USART_INT =1;		
		
		DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058)),DISABLE);	
	  num = 160 - DMA_GetCurrDataCounter(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058)));	
    ...
    look_usart_length=num;
		...
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058))->NDTR = 160;
		
		DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058)),ENABLE);		
		
		p_obj.data_fifo = JudgeSystemUart3_RXFIFO;	
		
		unpack_fifo_data(&p_obj, 0xA5);	
