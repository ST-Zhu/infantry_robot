...
#line 488 "..\\FWLIB\\inc\\stm32f4xx_flash.h"
...
#line 73 "..\\FWLIB\\src\\stm32f4xx_flash.c"
...
FLASH_Status FLASH_EraseAllSectors(uint8_t VoltageRange)
{
  ...
  if(status == FLASH_COMPLETE)
  {
    ...
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR &= ((uint32_t)0xFFFFFCFF);
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR |= tmp_psize;
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR |= (((uint32_t)0x00000004) | ((uint32_t)0x00008000));
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR |= ((uint32_t)0x00010000);
...
#line 596 "..\\FWLIB\\src\\stm32f4xx_flash.c"
...
void FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY)
{
  ...
  { 
    ...
    optiontmp =  (uint8_t)((*(volatile uint8_t *)((uint32_t)0x40023C14)) & (uint8_t)0x1F);
