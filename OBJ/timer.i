...
void TIM6_Configure(void)
{
    ...
    tim.TIM_CounterMode = ((uint16_t)0x0000);
    tim.TIM_ClockDivision = ((uint16_t)0x0000);
    tim.TIM_Period = 1000;  
    TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000)),&tim);
}
...
void TIM6_DAC_IRQHandler(void)  
{
    if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000)),((uint16_t)0x0001))!= RESET) 
	{
		...
		{
			time_ms_fire = 0;
			getEnconderData_fire(&fire_enconderL, 'L');
			getEnconderData_fire(&fire_enconderR, 'R');
		}
