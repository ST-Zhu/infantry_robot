...
#line 20 "..\\AHRS\\mpu6500driver_middleware.c"
...
#line 64 "..\\AHRS\\mpu6500driver_middleware.c"
}
...
{
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), ((uint16_t)0x0040));
}
void mpu6500_SPI_NS_L(void)
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), ((uint16_t)0x0040));
}

static uint8_t mpu6500_SPI_read_write_byte(uint8_t TxData)
{
    uint8_t retry = 0;
    while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5000)), ((uint16_t)0x0002)) == RESET)
    {
        retry++;
        if (retry > 200)
        {
    ...
    SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5000)), TxData);

    retry = 0;

    while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5000)), ((uint16_t)0x0001)) == RESET)
    {
        retry++;
        if (retry > 200)
        {
    ...
    return SPI_I2S_ReceiveData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5000)));
}
...
uint8_t mpu6500_read_single_reg(uint8_t reg)
{
    uint8_t res;
    mpu6500_SPI_NS_L();
    mpu6500_SPI_read_write_byte(reg | 0x80);
