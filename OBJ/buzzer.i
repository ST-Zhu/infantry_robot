...
void buzzer_init(uint16_t arr, uint16_t psc)
{
    ...
    RCC_APB1PeriphClockCmd(((uint32_t)0x00000040), ENABLE);
    ...
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1C00)), ((uint8_t)0x06), ((uint8_t)0x09));
    ...
    TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), &TIM_OCInitStructure);

    TIM_OC1PreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), ((uint16_t)0x0008));

    TIM_ARRPreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), ENABLE);
    ...
    TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), &TIM_TimeBaseInitStructure);
    TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), ENABLE);
...
void buzzer_on(void)
{
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800))->PSC = 95;
    TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), 10000);
}
void buzzer_off(void)
{
    TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), 0);
}
