...
#line 20 "..\\AHRS\\ist8310driver_middleware.c"
...
{
    uint8_t readBuf[3] = {0x0E | 0x80, 0x02, 0x88};
    mpu6500_write_muli_reg((0X25), readBuf, 3);
}

uint8_t ist8310_IIC_read_single_reg(uint8_t reg)
{
    static const uint16_t IIC_time = 2000;
    uint8_t readBuf[3] = {0x0E | 0x80, reg, 0x81};
    mpu6500_write_muli_reg((0X25), readBuf, 3);
    ist8310_delay_us(IIC_time);
    return mpu6500_read_single_reg((0x49));
}
void ist8310_IIC_write_single_reg(uint8_t reg, uint8_t data)
{
    uint8_t writeBuf[4] = {0x0E, reg, data, 0x80};

    mpu6500_write_muli_reg((0X31), writeBuf, 4);
}
...
{
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), ((uint16_t)0x0004));
}
extern void ist8310_RST_L(void)
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), ((uint16_t)0x0004));
}
