...
#line 648 "..\\FWLIB\\inc\\stm32f4xx_sai.h"
...
#line 127 "..\\FWLIB\\src\\stm32f4xx_sai.c"
#line 128 "..\\FWLIB\\src\\stm32f4xx_sai.c"
...
void SAI_DeInit(SAI_TypeDef* SAIx)
{
  ...
  {
#line 208 "..\\FWLIB\\src\\stm32f4xx_sai.c"
  }
}
...
#line 668 "..\\FWLIB\\src\\stm32f4xx_sai.c"
  ...
  case ((uint32_t)0x00000000) :
    tmpregisterGCR = 0U;
    break;
  case ((uint32_t)((uint32_t)0x00000010)) :
    tmpregisterGCR = ((uint32_t)0x00000010);
    break;
  case ((uint32_t)((uint32_t)0x00000020)) :
    tmpregisterGCR = ((uint32_t)0x00000020);
    break;
  default:
    break;
  }
  ((SAI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5800))->GCR = tmpregisterGCR;
