...
void uart_init(u32 bound){
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),((uint8_t)0x09),((uint8_t)0x07)); 
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),((uint8_t)0x0A),((uint8_t)0x07)); 
	
	
  GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0200) | ((uint16_t)0x0400); 
...
void USART1_IRQHandler(void)                	
{
	...
	{
		Res =USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)));
