...
{	
	...
	pid[PITCH_ANGLE].f_pid_init(&pid[PITCH_ANGLE], 50.0f, 0.0f, 0.0f, 250.0f, 50.0f, 100.0f, 250.0f);
	
	pid[PITCH_SPEED].f_pid_init = pid_init;
	pid[PITCH_SPEED].f_pid_init(&pid[PITCH_SPEED], 45.0f, 1.0f, 80.0f, 5000.0f, 500.0f, 1000.0f, 5000.0f);

	pid[YAW_ANGLE].f_pid_init = pid_init;
	pid[YAW_ANGLE].f_pid_init(&pid[YAW_ANGLE], 25.0f, 0.0f, 0.0f, 1000.0f, 50.0f, 500.0f, 1000.0f);

	pid[YAW_SPEED].f_pid_init = pid_init;
	pid[YAW_SPEED].f_pid_init(&pid[YAW_SPEED], 320.0f, 4.0f, 80.0f, 30000.0f, 1000.0f, 10000.0f, 30000.0f);
	
	pid[CHASSIS_FOLLOW].f_pid_init = pid_init;
	pid[CHASSIS_FOLLOW].f_pid_init(&pid[CHASSIS_FOLLOW], 10.0f, 0.0f, 100.0f, 500.0f, 0.0f, 500.0f, 500.0f);
